...
class ArticleView extends Component {
    ...
    render() {
        const { text, likes, title, feature_img, author } = this.props._article
                        ...
                        <div className="post-stats clearfix">
                            <div className="pull-left">
                                <div className="like-button-wrapper">
                                    <button onClick={() => this.props.like(this.props._article._id)} className="like-button" data-behavior="trigger-overlay" type="submit">
